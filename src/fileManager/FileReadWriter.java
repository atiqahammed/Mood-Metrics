...
//		System.out.println("File reading completed");
	...
	public ArrayList<String> getAllFileNameInDirectory(String directoryPath) {
		...
		for (File file : files) {
			if (file.isFile()) {
				Const.ALL_FILE_PATH.add(file.getAbsolutePath());
				filePath.add(file.getAbsolutePath());
//				System.out.println(file.getAbsolutePath());
			} else if (file.isDirectory()) {
				getAllFileNameInDirectory(file.getAbsolutePath());
			}
		}
